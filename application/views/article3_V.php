...
<div class="container"  style="color-background:white">
  ...
  <div class="row align-items-center my-5">
    <div class="col-lg-7">
      <img class="img-fluid rounded mb-4 mb-lg-0" src="https://wearecolorblind.com/wp-content/uploads/2018/10/think-and-talk-postimage-v2.jpg" alt="" style="max-width: 100%;">
    </div>
    <!-- /.col-lg-8 -->
    <div class="col-lg-5">
      <h1 class="font-weight-light" style="font-size:50px">How do the Colorblind Think and Talk about Color?</h1>
  ...
  <div class="row">
        ...
        <p>
          ...
          <p>
            <b>It’s about style and function</b>
            <br>
            ...
            <br>
            <br>
            t’s easier for the colorblind to stick to generalizations and avoid mistakes and embarrassment. “Blueish”, “kind of red”, “green, or grey”.
            <br>
            <br>
          </p>
          <p>
