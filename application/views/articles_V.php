...
<div class="row"  style="background-image: linear-gradient(#7AB3B0, #ddb075)">
  ...
  <div class="row align-items-center my-5">
    <div class="col-lg-7">
      <img class="img-fluid rounded mb-4 mb-lg-0" src="https://s3.amazonaws.com/www-inside-design/uploads/2018/11/colorblind-design-hero-1-810x810.jpg" alt="" style="max-width: 100%;">
    </div>
    <!-- /.col-lg-8 -->
    <div class="col-lg-5">
  ...
  <div class="row">
    <div class="col-md-4 mb-5">
      <div class="card h-100">
         <img src="https://cdn.shopify.com/s/files/1/0010/9215/7503/articles/Color-blind-grid_1000x.jpg?v=1549396074" class="card-img-top" alt="article2" >
        <div class="card-body" >
          <h2 class="card-title" style="font-size:20px">What Do Color Blind People See?</h2>
    ...
    <div class="col-md-4 mb-5">
      <div class="card h-100">
         <img src="https://wearecolorblind.com/wp-content/uploads/2018/10/think-and-talk-postimage-v2.jpg" class="card-img-top" alt="...">
        <div class="card-body">
