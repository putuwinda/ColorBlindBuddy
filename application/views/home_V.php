  ...
  <title>ColorBlind Buddy: An Aid For The Colorblind</title>
    ...
    <section style="background-color: #7AB3B0; height: 600px">
      <h1 class="site-heading text-center text-Black d-none d-lg-block" style="height: 30px;">
        <br/>
          <span class="site-heading-lower">COLORBLIND BUDDY</span><br/>
          <div style="font-size:50%">An Aid For The Colorblind</div>
          <hr style="width: 600px; background-color: gray">
      </h1>
    ...
    <div class="container">
      <div class="content-section-heading">
        ...
        <div style="color: black">Just click one of features below!</div>
        <br/>
      </div>
