...
<div class="container"  style="color-background: white">
  ...
  <div class="row align-items-center my-5">
    <div class="col-lg-7">
      <img class="img-fluid rounded mb-4 mb-lg-0" src="https://cdn.shopify.com/s/files/1/0010/9215/7503/articles/Color-blind-grid_1000x.jpg?v=1549396074" alt="" style="max-width: 90%;">
    </div>
    <!-- /.col-lg-8 -->
    <div class="col-lg-5">
      <h1 class="font-weight-light" style="font-size:50px">What Do Color Blind People See?</h1>
    ...
    <div class="card-body">
      <p class="text-black m-0" >
        <p>
          ...
          <br>
          <b> Some commonly confused colors include:</b>
          <br>
          <img src="https://i.pinimg.com/564x/84/4a/fc/844afcc6369d2c737cd09caed8d70dc3.jpg" alt=""style="max-width:50%">
          <br>
          <br>
          <br>

          <b>Color Blindness Definition</b>
          <br>
          ...
          <br>
          <img src="https://cdn.shopify.com/s/files/1/0010/9215/7503/t/5/assets/normal_color_vision.png?7400998785264446271" alt="normal-vision" style="max-width:50%">
          <p>Normal Vision</p>
          <br>
          <br>

          <img src="https://cdn.shopify.com/s/files/1/0010/9215/7503/t/5/assets/Deutan_Color_Blindness.png?1580019767571496456" alt="Deuteranormaly-color-blindness" style="max-width:50%">
          <p>Deutan Color Blindness Vision</p>
          <br>
          <br>
          Sports is another area where color blindness may inhibit some from playing at their full potential. Take cricket for instance. Because cricket is played with a dark pink ball on green grass, playing cricket with color blindness (also spelled "colour blindness") can easily cause confusion and dangerous in-play situations during this fast-moving sport.
          <br>
          <br>
          Unfortunately, those who are color blind also miss out on one of the most colorful experiences of the day: the sunset. The vibrant pinks, yellows, purples, reds, and oranges of the setting sun are often mostly lost on the color blind. The lower light conditions of sunset mixed with the presence of red in most of its colors make a sunset look bland and somewhat homogenous in color across the sky. Those who are color blind are unable to see the deeply varied layers of color in between.
