...
<html lang="en" dir="ltr">
  ...
  <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
    ...
    <title>A Quick Introduction to Color Blindness</title>
...
<div class="container"  style="color-background:white">
  ...
  <div class="row align-items-center my-5">
    <div class="col-lg-7">
      <img class="center-fit" src="https://wearecolorblind.com/wp-content/uploads/2018/10/quick-intro-postimage.jpg" alt="" style="max-width: 100%;">
    </div>
    <!-- /.col-lg-8 -->
    <div class="col-lg-5">
      <h1 class="font-weight-light" style="font-size:50px">A Quick Introduction to Color Blindness</h1>
  ...
  <div class="row">
    <br>
    <br>
       <p>About 4% of the population has some form of color blindness. In this article we’ll take a look at the basics of how color blindness works.
      <br>
      <br>
      ...
      <br>
      <br>
      <img src="https://wearecolorblind.com/wp-content/uploads/2011/11/introduction-to-graph-mutated.jpg" alt="">
      <br>
      ...
      <p>
        <ul>
          <li>Deuteranomaly: malfunctioning green cone (common) </li>
          <li>Deuteranopia: missing green cone (rare)</li>
          <li>Protanomaly: malfunctioning red cone (rare)</li>
          <li>Protanopia: missing red cone (rare)</li>
        </ul></p>
